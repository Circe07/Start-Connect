        ...
        return {
          ...
          orderBy() {
            ...
            return {
              ...
              limit() {
                return { async get() { return { size: docs.length, docs }; } };
              },
            };
          },
        };
              ...
              return {
                ...
                where() {
                  ...
                  return {
                    orderBy() { return this; },
                    startAfter() { return this; },
                    limit(n) { return { async get() { return { size: Math.min(docs.length, n), docs: docs.slice(0, n) }; } }; },
                  };
                },
              };
            },
...
describe("MVP E2E controller flows", () => {
  ...
  beforeEach(() => {
    ...
    jest.clearAllMocks();
    db = createMvpDb();
    db.__seed.activities.set("a1", { city: "Barcelona", interests: ["padel"], createdAt: new Date(), location: { lat: 41.38, lng: 2.17 } });
  ...
  test("Discover flow: activities -> swipe like -> matches", async () => {
    ...
    await swipesCtrl.recordSwipe({ user: { uid: "u1" }, body: { activityId: "a1", direction: "like" } }, swipeRes);
  ...
  test("Groups/chat flow: join -> send message -> list messages", async () => {
    ...
    await groupsCtrl.getMessages({ params: { id: "g1" }, user: { uid: "u2" }, query: { limit: "10" } }, listRes);
