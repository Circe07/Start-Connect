...
exports.createFeedback = async (req, res) => {
  try {
    ...
    const payload = {
      ...
      nota_app: req.body.nota_app,
      nota_club: req.body.nota_club,
      nota_host: req.body.nota_host,
      nota_companeros: req.body.nota_companeros,
      feedback_version: req.body.nota_app !== undefined ? 'v2' : undefined,
